...
namespace PSD.ClientAo.Auxs
{
    public class FlashWindowHelper
    {
        ...
        public void FlashApplicationWindow(Window window)
        {
            InitializeHandle(window);
            Flash(this.mainWindowHWnd, 5);
        }

        public void AFlashApplicationWindow(Window window)
        {
            window.Dispatcher.BeginInvoke((Action)(() =>
            {
                FlashApplicationWindow(window);
            }));
        }
        ...
        private void InitializeHandle(Window mainWindow)
        {
